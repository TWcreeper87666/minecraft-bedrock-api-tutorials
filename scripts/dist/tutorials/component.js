import { BlockComponentTypes, EntityComponentTypes, ItemComponentTypes, SignSide, world, } from "@minecraft/server";
/*
...
export function main(player) {
    ...
    if (block) {
        ...
        if (sign) {
            world.sendMessage(`SIGN TEXT: ${sign.getText(SignSide.Front)} ${sign.getText(SignSide.Back)}`);
        }
        else {
